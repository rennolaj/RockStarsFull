namespace RockStars.Api
{
    using Api.Filters;
    using ApiFramework.Attributes;
    using ApiFramework.Swagger;
    using RockStars.Common.Behaviours;
    using RockStars.Common.General;
    using RockStars.Common.Utilities;
    using Common;
    ...
    public static class DependencyInjection
    {
        ...
        {
            //app.UseSwagger();
            //app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RockStars.WebUI v1"));
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "RockStars.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "RockStars.WebUI v2");
